...
def welcomepic(pic, user, chatname, id, uname):
    ...
    font = ImageFont.truetype('ANNIEMUSIC/assets/annie/ArialReg', size=105)
    welcome_font = ImageFont.truetype('ANNIEMUSIC/assets/annie/ArialReg', size=60)
    draw.text((421, 715), f'{user}', fill=(242, 242, 242), font=font)
    draw.text((270, 1005), f'{id}', fill=(242, 242, 242), font=font)
    draw.text((570, 1308), f"{uname}", fill=(242, 242, 242), font=font)
