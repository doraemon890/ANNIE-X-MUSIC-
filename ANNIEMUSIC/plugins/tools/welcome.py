...
def welcomepic(pic, user, chatname, id, uname):
    ...
    draw.text((1800, 1030), f': {user}', fill=(238, 130, 238), font=font)
    draw.text((1560, 1260), f': {id}', fill=(238, 130, 238), font=font)
    draw.text((2050, 1470), f": {uname}", fill=(238, 130, 238), font=font)
