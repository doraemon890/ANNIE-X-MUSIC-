...
def welcomepic(pic, user, chatname, id, uname):
    ...
    draw.text((1800, 1020), f': {user}', fill=(252, 130, 119), font=font)
    draw.text((1560, 1250), f': {id}', fill=(252, 130, 119), font=font)
    draw.text((2050, 1460), f": {uname}", fill=(252, 130, 119), font=font)
